...
function buildGuidance(dominantElements, todayStemBranch, gender, tone, birthUtcMs) {
  ...
  const toneSet = {
    balanced: {
      summary: [
        `${dominantElements.join('·')} 기운이 강한 날입니다. 오늘은 속도를 조절하며 핵심에 집중하면 안정적인 성과가 있습니다. 아침에는 우선순위를 정리하고, 오후에는 확실한 한 가지를 끝내는 흐름이 좋습니다. 무리한 확장보다 지금 가진 자원을 단단히 다지는 것이 이득입니다.<br><br>감정적으로는 들뜨기보다 차분함이 도움됩니다. 해야 할 일의 범위를 정하고, 가능하면 ‘오늘 끝낼 것’과 ‘미룰 것’을 구분해 두세요. 작은 실수를 줄이는 것만으로도 결과의 질이 달라집니다.<br><br>하루 마무리에는 정리 시간이 필요합니다. 계획을 짧게 회고하면 내일의 속도가 빨라지고, 오늘의 성과가 더 선명하게 남습니다.`,
    ...
    warm: {
      summary: [
        `${dominantElements.join('·')} 기운이 포근하게 감싸는 날입니다. 오늘은 자신을 다독이면서도 한 걸음씩 나아가면 좋은 흐름이 이어집니다. 완벽을 요구하기보다 ‘가능한 만큼’의 리듬을 유지하면 마음과 결과가 동시에 안정됩니다. 작은 성취를 소중히 여기는 태도가 운을 키웁니다.<br><br>감정의 파동이 있을 수 있지만, 억지로 밀어붙이기보다 가볍게 다듬는 선택이 좋습니다. 할 수 있는 만큼을 해내고, 남은 것은 내일로 넘기는 여유가 필요합니다.<br><br>하루의 끝에는 자신을 칭찬해 주세요. 따뜻한 에너지가 내일의 추진력을 만들고, 관계에서도 안정감을 줍니다.`,
    ...
    sharp: {
      summary: [
        `${dominantElements.join('·')} 기운이 뚜렷하게 드러나는 날입니다. 오늘은 미루지 말고 핵심부터 처리해야 결과가 나옵니다. 애매한 일을 정리하고 확실한 것부터 끝내면 속도와 성과가 동시에 확보됩니다. 시간을 지키는 것이 곧 운을 지키는 날입니다.<br><br>선택을 미루면 비용이 늘어납니다. 과감하게 정리하고, 남길 것과 버릴 것을 분리하세요. 오늘은 ‘정리의 날’로 정하면 흐름이 빠르게 개선됩니다.<br><br>관계에서도 기준을 명확히 하는 것이 필요합니다. 애매한 합의는 되돌아옵니다. 분명한 합의가 곧 자유를 만들어 줍니다.`,
        `${dominantElements.join('·')} 흐름이 강하게 잡힙니다. 결정은 빠르게, 실행은 단호하게 하세요. 미룰수록 비용이 커지고, 정리할수록 길이 열립니다. 오늘은 ‘과감한 정리’가 가장 큰 이득입니다.<br><br>중요한 일부터 처리하면 하루가 길게 느껴집니다. 작은 일에 매이지 말고, 핵심 하나를 끝내는 전략이 좋습니다. 의사결정은 최대한 간결하게 하세요.<br><br>피로 누적을 방치하지 말고, 필요한 만큼 쉬어야 다음 속도가 나옵니다. 리듬을 지키는 것이 가장 큰 전략입니다.`
      ],
      todayEnergy: [
